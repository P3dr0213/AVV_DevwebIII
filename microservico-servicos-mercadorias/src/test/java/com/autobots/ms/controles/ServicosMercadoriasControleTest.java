...
public class ServicosMercadoriasControleTest {
	...
	@Test
	public void testGetServicosMercadorias() throws Exception {
		mockMvc.perform(get("/servicos-mercadorias/empresas/1")
